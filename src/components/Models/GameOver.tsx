...
export default function GameOver() {
    ...
    return (
        <MahjongModel open={true} extraCss="xs:w-[363px] max-h-[80%] overflow-hidden">
            <div className="flex flex-col">
                <Image src={ICONS.MahjongTextIcon} alt="Image" className="mx-auto" />
                {
                    users.map((user, index) => {
                        return (
                            <div key={index} className="mt-4 flex flex-col justify-between">
                                <div className="border-b border-white border-opacity-10 h-full">
                                ...
                                <div className="mt-4 flex-grow overflow-auto h-full">
                                    {
